...
export default function EntityError({ error, reset }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4 text-center px-4">
      ...
      <div className="space-y-1">
        <h2 className="text-base font-semibold">Impossibile caricare i dati</h2>
        <p className="text-sm text-muted-foreground">
          La risorsa richiesta non è disponibile o si è verificato un errore.
        </p>
      </div>
